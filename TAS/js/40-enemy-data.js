...
function definedEnemyFields(monster){
  ...
  patch.unknownName='不気味な影';
  ['surface','trait','ambushTrigger'].forEach(key=>monsterDefinedText(patch,key,monster?.[key]));
