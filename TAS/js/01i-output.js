...
delete merged.enemyId;delete merged.enemyName;delete merged.identifySecret;delete merged.revealOnDefeat;delete merged.type;delete merged.index;delete merged.discoveries;delete merged.transitions;delete merged.dialogueRules;delete merged.gmSceneNotes;return merged});const chapter={...baseChapter,title:baseChapter.title||CHAPTERS[activeChapter].name,scenes};
