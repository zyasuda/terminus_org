...
const castAttribute=(id)=>{const value=castAttributes[id]||{};const addressTerm=String(value.addressTerm||value.addressing||"");const speechFrequency=["none","low","standard","high"].includes(value.speechFrequency)?value.speechFrequency:"standard";return {gender:value.gender||"unspecified",firstPerson:String(value.firstPerson||""),addressTerm,speechRules:String(value.speechRules||""),speechFrequency};};
