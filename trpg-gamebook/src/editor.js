...
function aiPanel(node) {
  ...
  const message = !hasKey() || !getModel() ? `<p class="hint">シーンに必要な要素について質問します</p>` : "";
